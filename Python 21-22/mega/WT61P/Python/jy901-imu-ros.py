        ...
        if FrameState == 0:
            ...
            if Bytenum < 10:
                ...
                if data == (CheckSum & 0xff):
                    ...
                    print
                    "acceleration(m/s2):\t%10.3f %10.3f %10.3f" % a
                    print
                    "angular vel(deg/s):\t%10.3f %10.3f %10.3f" % w
                    print
                    "angle(deg):\t\t%10.3f %10.3f %10.3f" % Angle
                    print
                    "angle_quat:\t\t%10.3f %10.3f %10.3f %10.3f" % Angle_quat
                    print
                    "====================================================================="
...
if __name__ == '__main__':
    ...
    ser = serial.Serial(port='/dev/ttyUSB0', baudrate='9600',
                        timeout=1)  # ser = serial.Serial('com7',115200, timeout=0.5)
    print(ser.is_open)
