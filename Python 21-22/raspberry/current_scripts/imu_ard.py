...
class ArduinoIMU(IMU):
    ...
    Kp = [[0.3, 0.0, 0.0], [0.3, 0.4, 0.4]]  # constant to modify PID
    Ki = [[0.008, 0.00, 0.00], [0.1, 0.1, 0.1]]  # constant to modify PID
    Kd = [[0.01, 0.0, 0.0], [0.1, 0.1, 0.1]]  # constant to modify PID
    ...
    def UpdateAngle(self):
        ...
        # print(self.parseAngles())
        anglecenter, anglerear = self.parseAngles()

        self.Angle[YAW] = round(((anglecenter[0] - startcenter[0]) + (anglerear[0] - startright[0])) / 2, 4)
